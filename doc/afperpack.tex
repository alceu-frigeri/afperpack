...
%\usepackage{CircuitsI}
%\usepackage{CircuitsII}
%\usepackage{CircuitsMisc}
%\usepackage{ElectronicsI}
...
This bundle includes  a personal pre-configuration package, which (selectively) loads package sets with the author pre-defined package options, and a few associated packages as ``circuits libraries'' (set's of quests based on \tsobj[pkg]{tikzquests}).
